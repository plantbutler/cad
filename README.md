...
- [`wiring/`](wiring/README.md) — how the bench is wired: four drawings (overview, pump
  switching, sensor bus, power), the pin map with connectors and wire colours, the parts to
